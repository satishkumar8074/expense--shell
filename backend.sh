...
echo -e "${color}  copying from backend.service \e[0m"
...
echo -e "${color} creating the id \e[0m"
id expense >>log_file
if  [ $? -eq 0 ]; then
echo -e "\e[32m success \e[0m"
else
...
echo -e "${color} adding the expense user \e[0m"
...
echo -e "${color} changing the directory and unzipping the file \e[0m"
cd /app >>log_file
